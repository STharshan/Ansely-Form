          ...
          <div className="max-w-6xl mx-auto">
              ...
              <div className="mt-8 space-y-6">
                  ...
                  <section>
                      ...
                      <p className="text-white">
                          All content on this website (including text, images, graphics, and logos) is owned by or licensed to Ansely.
                  ...
                  <section>
                      ...
                      <div className="text-white">
                          <p><strong>Ansely</strong></p>
                          <p>Email: <a href="mailto:Contact@Ansely.co.uk" className="text-orange-400 hover:underline">Contact@Ansely.co.uk</a></p>
                          <p>Phone: +44 738 0909597</p>
                      </div>
                  </section>
              </div>
          </div>
